...
/**
 * Clase principal del sistema de simulación.
 * Contiene el método de entrada {@link #main(String[])} desde donde se ejecuta
 * el menú CRUD para la gestión de usuarios.
 * <p>
 * También define métodos polimórficos de apoyo usados en las pruebas del sistema.
 * </p>
 *
...
public class Principal {
	 ...
	 * Ejecuta el menú interactivo CRUD para la gestión de usuarios.
	 *
	...
	public static void main(String[] args) {
		...
		crud.modificar("UP001", usuarioVip);
		crud.eliminar(null);
		crud.eliminar("");
		...
		while (opcion != 0) {
			...
			switch (opcion) {
				...
				case 1:
					...
					System.out.print("Sexo: "); String sexo = scanner.nextLine();
					...
					System.out.print("Especie: "); String especie = scanner.nextLine();
					System.out.print("Raza: "); String raza = scanner.nextLine();
					System.out.print("Tamaño: "); String tamanio = scanner.nextLine();
					Tipo_de_usuario tipoUsuario = new Tipo_de_usuario(tipoId, especie, raza, tamanio);

					if (tipo == 1) {
						System.out.print("Ocupacion: "); String ocupacion = scanner.nextLine();
						System.out.print("Nivel educativo: "); String nivelEdu = scanner.nextLine();
				...
				case 4:
					...
					System.out.println("  3. UsuarioVIP");
					System.out.print("Seleccione tipo: ");
					int tipoMod = scanner.nextInt();
					scanner.nextLine();

					System.out.print("Nombre: "); String nombreMod = scanner.nextLine();
					System.out.print("Sexo: "); String sexoMod = scanner.nextLine();
					...
					System.out.print("Especie: "); String especieMod = scanner.nextLine();
					System.out.print("Raza: "); String razaMod = scanner.nextLine();
					System.out.print("Tamaño: "); String tamanioMod = scanner.nextLine();
					Tipo_de_usuario tipoUsuarioMod = new Tipo_de_usuario(tipoIdMod, especieMod, razaMod, tamanioMod);

					if (tipoMod == 1) {
						System.out.print("Ocupacion: "); String ocupacionMod = scanner.nextLine();
						System.out.print("Nivel educativo: "); String nivelEduMod = scanner.nextLine();
	...
	/**
	 * Método polimórfico que recibe un usuario de cualquier subclase e imprime
	 * por consola el porcentaje de descuento calculado para ese usuario.
	 *
	 * @param usuario Objeto de tipo {@link Usuario} (o cualquier subclase) a evaluar.
	 */
	...
	/**
	 * Método polimórfico que crea y retorna un usuario genérico de tipo persona.
	 * El objeto retornado es de tipo {@link Usuario} (supersuperclase).
	 *
