...
public class Principal {
	...
	public static Usuario crearUsuarioGenerico(Tipo_de_usuario tipo) {
		return new UsuarioPersona("102424524", "Aejandra Rueda", "Femenino", 20, "1.70",
				tipo, "alejita524@gmail.com", "3246847152",
				"Estudiante", "Universitario", "00000000", "O+");
	}
	...
	public static void main(String[] args) {
		...
		UsuarioPersona usuarioPersona = new UsuarioPersona("1024985449", "Nicolas Atehortua", "Masculino", 35, "1.70", tipoHumano, "nikolasd29@gmail.com", "3246847152", "Ingeniero", "Universitario", "1024985449", "O+");
		...
		UsuarioVIP usuarioVip = new UsuarioVIP("51604325", "Laura Gomez", "Femenino", 28, "1.65", tipoHumano, "laurita2026@gmail.com", "3101234567", "Medico", "Universitario", "2058741236", "A+", "Platino");

		Enfermedad enfermedad3 = new Enfermedad("Asma", "Leve", "Permanente", "E003");
		usuarioVip.setEnfermedades(new Enfermedad[] { enfermedad3 });

		UsuarioAnimal usuarioAnimal = new UsuarioAnimal("A001", "Rocky", "Macho", 3, "0.40", tipoAnimal, "perro@hotmail.com", "3009876543", "Perro", "Labrador", "Pequeño", true);
		...
		// Objetos Turno
		System.out.println("\n********** OBJETOS TURNO **********");
		Turno turnoPersona = new Turno("TU001", usuarioPersona, "16/02/2026", "10:00", "13:00", "3 horas", instructor, simulador1, curso);
		Turno turnoVip = new Turno("TU002", usuarioVip, "17/02/2026", "14:00", "17:00", "3 horas", instructor, simulador1, curso);
		Turno turnoAnimal = new Turno("TU003", usuarioAnimal, "18/02/2026", "09:00", "11:00", "2 horas", instructor, simulador2, curso);
